...
const Profile = () => {
  ...
  const deleteId = async () => {
    try {
      await axios.post(`https://new-backend-pied.vercel.app/api/users/delete/${id}`, {}, { withCredentials: true });
  ...
  const handleUpload = async (selectedImage) => {
    try {
      ...
      const response = await axios.post(`https://new-backend-pied.vercel.app/api/users/imageupload/${id}`, formData, { withCredentials: true });
