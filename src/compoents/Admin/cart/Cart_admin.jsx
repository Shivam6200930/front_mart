...
const Cart = () => {
  ...
  const handleNextPage = () => {
    setCurrentPage(nextPage => Math.min(nextPage, Math.ceil(cartItems.length / itemsPerPage)));
  };
          ...
          {displayedItems.map((item, index) => (
            <div key={index} className="cart-item">
              ...
              <div className="quantity-container">
                <button className="quantity-btn" onClick={() => decreaseQuantity(startIndex + index)}><span>-</span></button>
                <span>{item.quantity}</span>
                <button className="quantity-btn" onClick={() => increaseQuantity(startIndex + index)}><span>+</span></button>
              </div>
